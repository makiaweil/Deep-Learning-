...
class myMLP(object):
    def __init__(self, rng, input, n_in, n_hidden, n_out, depth,a):
        ...
        self.hiddenLayer = self.hiddenLayers[-1]
        ...
        for layer in self.hiddenLayers:
            self.L2_sqr =self.L2_sqr +  (layer.W ** 2).sum()
...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=10,
             batch_size=20, n_hidden=500, verbose=True,activ=T.tanh,depth=2):
    """
